...
const links = <>
  <NavLink to="/" className={({ isActive, isPending }) =>
    isPending ? "pending" : isActive ?
      "text-[#355aa2] font-bold underline" : ""
  }>Home</NavLink>
    ...
    <div>
      <div className="navbar bg-base-100 rounded-xl p-4 mt-4">
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost normal-case invisible md:visible text-blue-900  text-4xl font-bold">
        ...
        <div className="navbar-end gap-0 lg:gap-5">
          ...
          </div>
          {
            user ?
              ...
              :
              <button className='btn btn-primary text-white bg-blue-900 border-white normal-case'>
